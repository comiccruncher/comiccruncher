...
func (m *MockCharacterStatsSyncer) SyncAll(characters []*comic.Character) <-chan comic.CharacterSyncResult {
	ret := m.ctrl.Call(m, "SyncAll", characters)
	ret0, _ := ret[0].(<-chan comic.CharacterSyncResult)
	return ret0
}
...
func (mr *MockCharacterStatsSyncerMockRecorder) SyncAll(characters interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SyncAll", reflect.TypeOf((*MockCharacterStatsSyncer)(nil).SyncAll), characters)
}
